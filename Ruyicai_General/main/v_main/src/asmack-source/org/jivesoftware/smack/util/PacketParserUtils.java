...
public class PacketParserUtils {
    ...
    public static Packet parseMessage(XmlPullParser parser) throws Exception {
        ...
        //以下是自定义的
        message.setMsgtype(parser.getAttributeValue("", "msgtype"));
        message.setMsgTime(parser.getAttributeValue("", "msgTime"));
        message.setFromHeadImg(parser.getAttributeValue("", "fromHeadImg"));
        message.setContentType(parser.getAttributeValue("", "contentType"));
        message.setContentID(parser.getAttributeValue("", "contentID"));
        message.setPicID(parser.getAttributeValue("", "picID"));
        message.setmContent(parser.getAttributeValue("", "content"));
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (elementName.equals("subject")) {
                    ...
                    String payload = parseContent(parser);
                    
                    if (message.getPayload(xmlLang) == null) {
                        message.addPayload(xmlLang, payload);
                    }
                }
