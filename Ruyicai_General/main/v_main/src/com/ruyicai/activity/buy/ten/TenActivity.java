...
public class TenActivity extends ZixuanAndJiXuan {
	 ...
	 * 初始化自选选区
	 */
	private void createViewZx(int id) {
		iProgressBeishu = 1;
		iProgressQishu = 1;
		sscCode = new TenCode();
		initArea();
	 ...
	 * 初始化机选选区
	 */
	private void createViewJx(int id) {
		iProgressBeishu = 1;
		iProgressQishu = 1;
	...
	private void initView() {
		...
		titleOne.setText(getString(R.string.tenTitle));
	 ...
	 * 创建下拉列表
	 */
	private void createDialog(final int Lotno) {
		...
		layoutQuery.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (userno == null || "".equals(userno)) {
					...
					Intent intent = new Intent(TenActivity.this, BetQueryActivity.class);
		...
		layoutPicture.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				layoutPicture
						.setBackgroundResource(R.drawable.buy_group_layout_b);
				Intent intent = new Intent(TenActivity.this, NoticeActivityGroup.class);
		...
		if (getIsLuck()) {
			...
			layoutLuck.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					layoutLuck
							.setBackgroundResource(R.drawable.buy_group_layout_b);
					Intent intent = new Intent(TenActivity.this, LuckChoose2.class);
					intent.putExtra("lotno", lotno);
	...
	public void turnHosity() {
		Intent intent = new Intent(TenActivity.this,
				...
				try {
					...
					if (code.equals("0000")) {
						...
						tHandler.post(new Runnable() {
							@Override
							public void run() {
								Toast.makeText(TenActivity.this, msg,
	...
	private void nextIssue() {
		new AlertDialog.Builder(TenActivity.this)
				.setTitle("提示")
				.setMessage(
	...
	protected void onResume() {
		...
		controller = Controller.getInstance(TenActivity.this);
