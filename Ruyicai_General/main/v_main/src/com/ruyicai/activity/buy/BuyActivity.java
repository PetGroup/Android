...
//	private List<String> mLabelArray = new ArrayList<String>();
	...
	private int[] imageViews = { R.drawable.ico_buy, R.drawable.ruyi_guess_icon, R.drawable.ico_double,
			...
			R.drawable.ico_timec, R.drawable.icon_jc_gyj, R.drawable.icon_jc
			,R.drawable.happy_poker_icon, R.drawable.icon_newk3, R.drawable.nmk3_ico,
	...
	private String[] imageTitle = { "合买大厅", "如意竞猜", "双色球", "大乐透", "福彩3D", "江西11选5",
			"时时彩", "竞彩冠军", "竞彩足球","快乐扑克","新快三", "快三", "11运夺金", "专家荐号", "广东11选5",
			"排列三", "七乐彩","22选5", "排列五", "七星彩", "足彩", "竞彩篮球", "广东快乐十分", 
			"北京单场" ,"重庆11选5"};


	private final Class[] cla = { JoinInfoActivity.class, RuyiGuessActivity.class, 
			Ssq.class, Dlt.class,
			Fc3d.class, Dlc.class, Ssc.class, ZqMainActivity.class, ZqMainActivity.class
			,HappyPoker.class,JiLinK3.class ,
				...
				if (Constants.todayjosn != null) {
					if (!lotno.equals("hmdt") && !lotno.equals("zjjh")) {
							try {
								...
								if (PublicMethod.isExistFields(jsonobj,"isTodayOpenPrize")) {
									isTodayOpenPrize = jsonobj
