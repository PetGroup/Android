...
public abstract class Packet implements Serializable{
    ...
    private String msgtype = null;//自定义字段
    private String msgTime = null;//自定义字段
    private String fromHeadImg = null;//自定义字段
    private String contentType = null;//自定义字段
    private String contentID = null;//自定义字段
    private String picID = null;//自定义字段
